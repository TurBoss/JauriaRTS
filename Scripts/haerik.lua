...
Animations['resetAnimation'] = VFS.Include("Scripts/animations/haerik/reset.lua", scriptEnv);

Animations['moveAnimation'] = VFS.Include("Scripts/animations/haerik/move.lua", scriptEnv);
